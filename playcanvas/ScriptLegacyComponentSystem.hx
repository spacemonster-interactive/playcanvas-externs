...
@:jsRequire("playcanvas", "ScriptLegacyComponentSystem") extern class ScriptLegacyComponentSystem extends ComponentSystem {
	...
	var DataType : {
		var prototype : ScriptLegacyComponentData;
	};
	var preloading : Bool;
