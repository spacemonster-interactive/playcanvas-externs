...
**/
@:native("pc.ForwardRenderer") extern class ForwardRenderer extends playcanvas.Renderer {
	...
	**/
	function buildFrameGraph(frameGraph:playcanvas.FrameGraph, layerComposition:LayerComposition):Void;
	function addMainRenderPass(frameGraph:playcanvas.FrameGraph, layerComposition:LayerComposition, renderTarget:Dynamic, startIndex:Dynamic, endIndex:Dynamic, isGrabPass:Dynamic):Void;
	...
	**/
	...
	function renderRenderAction(comp:LayerComposition, renderAction:playcanvas.RenderAction, firstRenderAction:Bool):Void;
