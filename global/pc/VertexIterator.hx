...
**/
@:native("pc.VertexIterator") extern class VertexIterator {
	/**
	...
	**/
	...
	var accessors : Array<playcanvas.VertexIteratorAccessor>;
	/**
		The vertex buffer elements.
	**/
	var element : haxe.DynamicAccess<playcanvas.VertexIteratorAccessor>;
	/**
