...
**/
@:jsRequire("playcanvas", "ParticleSystemComponentSystem") extern class ParticleSystemComponentSystem extends ComponentSystem {
	var id : String;
	var ComponentType : {
	...
	var DataType : {
		var prototype : ParticleSystemComponentData;
	};
	var propertyTypes : {
