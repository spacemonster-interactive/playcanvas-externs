...
**/
@:native("pc.MeshInstance") extern class MeshInstance {
	/**
	...
	**/
	var _bindGroups : Array<playcanvas.BindGroup>;
	...
	**/
	...
	var instancingData : playcanvas.InstancingData;
	...
	**/
	...
	function getBindGroup(device:GraphicsDevice, pass:Float):playcanvas.BindGroup;
	var _layer : Dynamic;
	/**
	...
	**/
	function updatePassShader(scene:Scene, pass:Float, staticLightList:Dynamic, sortedLights:Dynamic, viewUniformFormat:playcanvas.UniformBufferFormat, viewBindGroupFormat:playcanvas.BindGroupFormat):Void;
