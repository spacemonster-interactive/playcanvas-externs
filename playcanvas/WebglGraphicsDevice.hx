...
**/
@:jsRequire("playcanvas", "WebglGraphicsDevice") extern class WebglGraphicsDevice extends GraphicsDevice {
	/**
	...
	**/
	...
	function createVertexBufferImpl(vertexBuffer:Dynamic, format:Dynamic):WebglVertexBuffer;
	function createIndexBufferImpl(indexBuffer:Dynamic):WebglIndexBuffer;
	function createShaderImpl(shader:Dynamic):WebglShader;
	function createTextureImpl(texture:Dynamic):WebglTexture;
	function createRenderTargetImpl(renderTarget:Dynamic):WebglRenderTarget;
