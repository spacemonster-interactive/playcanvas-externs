...
@:jsRequire("playcanvas", "WebgpuGraphicsDevice") extern class WebgpuGraphicsDevice extends GraphicsDevice {
	...
	**/
	var renderPipeline : WebgpuRenderPipeline;
	/**
		Object responsible for clearing the rendering surface by rendering a quad.
	**/
	var clearRenderer : WebgpuClearRenderer;
	/**
		Object responsible for mipmap generation.
	**/
	var mipmapRenderer : WebgpuMipmapRenderer;
	/**
	...
	**/
	var bindGroupFormats : Array<WebgpuBindGroupFormat>;
	/**
	...
	**/
	...
	function createUniformBufferImpl(uniformBuffer:Dynamic):WebgpuUniformBuffer;
	function createVertexBufferImpl(vertexBuffer:Dynamic, format:Dynamic):WebgpuVertexBuffer;
	function createIndexBufferImpl(indexBuffer:Dynamic):WebgpuIndexBuffer;
	function createShaderImpl(shader:Dynamic):WebgpuShader;
	function createTextureImpl(texture:Dynamic):WebgpuTexture;
	function createRenderTargetImpl(renderTarget:Dynamic):WebgpuRenderTarget;
	function createBindGroupFormatImpl(bindGroupFormat:Dynamic):WebgpuBindGroupFormat;
	function createBindGroupImpl(bindGroup:Dynamic):WebgpuBindGroup;
	function setBindGroup(index:Float, bindGroup:BindGroup):Void;
	...
	**/
	...
	/**
		Start a render pass.
	**/
	function startPass(renderPass:RenderPass):Void;
	var passEncoder : Dynamic;
	/**
		End a render pass.
	**/
	function endPass(renderPass:RenderPass):Void;
