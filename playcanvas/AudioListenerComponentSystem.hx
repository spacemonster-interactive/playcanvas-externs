...
**/
@:jsRequire("playcanvas", "AudioListenerComponentSystem") extern class AudioListenerComponentSystem extends ComponentSystem {
	var id : String;
	var ComponentType : {
	...
	var DataType : {
		var prototype : AudioListenerComponentData;
	};
