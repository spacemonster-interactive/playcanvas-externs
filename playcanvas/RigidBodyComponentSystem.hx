...
**/
@:jsRequire("playcanvas", "RigidBodyComponentSystem") extern class RigidBodyComponentSystem extends ComponentSystem {
	...
	**/
	...
	var DataType : {
		var prototype : RigidBodyComponentData;
	};
	var contactPointPool : ObjectPool;
	var contactResultPool : ObjectPool;
	var singleContactResultPool : ObjectPool;
	var collisions : { };
	var frameCollisions : { };
	/**
