...
**/
@:jsRequire("playcanvas", "GamePads") extern class GamePads extends EventHandler {
	/**
	...
	**/
	function poll(?pads:Array<GamePad>):Array<GamePad>;
	/**
	...
	**/
	function findById(id:String):Null<GamePad>;
	/**
		Find a connected {@link GamePad} from its device index.
	**/
	function findByIndex(index:Float):Null<GamePad>;
