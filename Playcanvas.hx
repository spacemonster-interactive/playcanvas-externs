@:jsRequire("playcanvas") @valueModuleOnly extern class Playcanvas {
	...
	**/
	...
	/**
		...
		for entities.
	**/
	static function createScript(name:String, ?app:playcanvas.AppBase):Null<{
		var prototype : playcanvas.ScriptType;
		/**
		...
		**/
		final attributes : playcanvas.ScriptAttributes;
		/**
	...
	**/
	static function createShader(device:playcanvas.GraphicsDevice, vsName:String, fsName:String, ?useTransformFeedback:Bool):playcanvas.Shader;
	/**
	...
	**/
	static function createShaderFromCode(device:playcanvas.GraphicsDevice, vsCode:String, fsCode:String, uniqueName:String, ?attributes:haxe.DynamicAccess<String>, ?useTransformFeedback:Bool):playcanvas.Shader;
	/**
	...
	**/
	static function drawQuadWithShader(device:playcanvas.GraphicsDevice, target:Null<playcanvas.RenderTarget>, shader:playcanvas.Shader, ?rect:playcanvas.Vec4, ?scissorRect:playcanvas.Vec4, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		Draws a texture in screen-space. Mostly used by post-effects.
	**/
	static function drawTexture(device:playcanvas.GraphicsDevice, texture:playcanvas.Texture, ?target:playcanvas.RenderTarget, ?shader:playcanvas.Shader, ?rect:playcanvas.Vec4, ?scissorRect:playcanvas.Vec4, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	...
	static final http : playcanvas.Http;
	...
	**/
	static function registerScript(script:{ var prototype : playcanvas.ScriptType; /** Name of a Script Type. **/ var __name : Dynamic; var __getScriptName : Dynamic; /** Name of a Script Type. **/ final scriptName : String; /** The interface to define attributes for Script Types. Refer to {@link ScriptAttributes}. **/ final attributes : playcanvas.ScriptAttributes; /** Shorthand function to extend Script Type prototype with list of methods. **/ function extend(methods:Dynamic):Void; }, ?name:String, ?app:playcanvas.AppBase):Void;
	/**
	...
	**/
	static function reprojectTexture(source:playcanvas.Texture, target:playcanvas.Texture, ?options:{ @:optional var specularPower : Float; @:optional var numSamples : Float; @:optional var face : Float; @:optional var distribution : String; @:optional var rect : playcanvas.Vec4; @:optional var seamPixels : Float; }, args:haxe.extern.Rest<Dynamic>):Void;
