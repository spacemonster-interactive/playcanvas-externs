...
**/
@:jsRequire("playcanvas", "PostEffectQueue") extern class PostEffectQueue {
	/**
	...
	**/
	var effects : Array<PostEffect__>;
	/**
	...
	**/
	function addEffect(effect:PostEffect__):Void;
	var _sourceTarget : Dynamic;
	var _newPostEffect : PostEffect__;
	/**
		Removes a post effect from the queue. If the queue becomes empty it will be disabled
		automatically.
	**/
	function removeEffect(effect:PostEffect__):Void;
