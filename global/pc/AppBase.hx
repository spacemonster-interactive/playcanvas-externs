...
/**
	...
	manually.
**/
@:native("pc.AppBase") extern class AppBase extends EventHandler {
	/**
	...
	**/
	...
	var stats : playcanvas.ApplicationStats;
	...
	**/
	...
	var sceneGrab : playcanvas.SceneGrab;
	...
	**/
	...
	/**
		The frame graph.
	**/
	var frameGraph : playcanvas.FrameGraph;
	/**
