...
/**
	...
	rendering order.
**/
@:jsRequire("playcanvas", "LayerComposition") extern class LayerComposition extends EventHandler {
	/**
	...
	**/
	var _renderActions : Array<RenderAction>;
	...
	function addRenderAction(renderActions:Dynamic, renderActionIndex:Dynamic, layer:Dynamic, layerIndex:Dynamic, cameraIndex:Dynamic, cameraFirstRenderAction:Dynamic, postProcessMarked:Dynamic):RenderAction;
