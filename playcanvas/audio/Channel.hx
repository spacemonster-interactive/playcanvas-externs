...
**/
@:jsRequire("playcanvas", "audio.Channel") extern class Channel {
	/**
		Create a new Channel instance.
	**/
	function new(manager:playcanvas.SoundManager, sound:playcanvas.Sound, ?options:{ @:optional var volume : Float; @:optional var pitch : Float; @:optional var loop : Bool; });
	var volume : Float;
	var loop : Bool;
	var pitch : Float;
	var sound : playcanvas.Sound;
	var paused : Bool;
	var suspended : Bool;
	var manager : playcanvas.SoundManager;
